    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            LazyVGrid(columns: columns) {
                SowingAndPlantingRowView(imageName: "sun", label: "Optimal Sun", value: vegetable.careAndMaintenance!.optimalSun, imageWidth: 45)
                SowingAndPlantingRowView(imageName: "temperature", label: "Soil Temp", value: vegetable.careAndMaintenance!.growingSoilTemp, imageWidth: 45)
            }
...
struct CareAndMaintenanceView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        CareAndMaintenanceView(vegetable: data.vegetables[0], selectedVariety: $selectedVariety)
    }
}
